...
//update fir (add a prisoner id)
    ...
    if(isset($_SESSION['userUidOfficer'])){
      ...
      <div class="container px-5 py-24 mx-auto">
        ...
        <div class="flex-grow pl-6">
          <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Update Section of Jailor</h2>
          <p class="leading-relaxed text-base">Update the section of the jailor</p>
