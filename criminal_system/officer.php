...
<form action="includes/officer.inc.php" method="post" >
      ...
      <div class="lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div class="p-2 w-1/2">
          ...
          <div class="p-2 w-full">
            <button
            name="officer_add" type="submit" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"
            >
              Submit
            </button>
          </div>
